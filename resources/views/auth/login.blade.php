...
<style>
    ...
    .bg-glow-2 { bottom: -100px; right: -100px; background: radial-gradient(circle, rgba(168, 85, 247, 0.12) 0%, transparent 70%); }
        ...
        <div class="split-card fade-in">
            ...
            <div class="row-actions">
                <p class="action-summary">
                    Browser login is restricted for security.<br>
                    Please use our secure desktop application.
                </p>
