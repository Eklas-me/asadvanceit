...
@section('content')
    <div class="page-header fade-in">
        <h1 class="page-title">Suspended Users</h1>
    </div>
        ...
        <div class="col-12">
            ...
            <div class="aero-card" style="position: relative;">
                ...
                <div class="aero-card-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <h2 class="aero-card-title">Suspended Users List</h2>
                            ...
                            @if($suspendedUsers->isEmpty())
                                <tr>
                                    <td colspan="9" class="text-center" style="padding: 60px 20px; color: var(--text-muted);">
                                        <i class="fas fa-user-slash fa-4x mb-3" style="opacity: 0.2;"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content aero-card">
                ...
                <div class="modal-body">
                    <p class="mb-3">Are you sure you want to delete <strong id="deleteUserCount"></strong> users?</p>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="button" onclick="executeBulkDelete()" class="aero-btn"
    ...
    <script>
        ...
        function confirmBulkDelete() {
            const ids = getSelectedIds();
            if (ids.length === 0) return;
            document.getElementById('deleteUserCount').textContent = ids.length;
